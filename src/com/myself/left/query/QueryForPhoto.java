...
public class QueryForPhoto {
    public Userphoto queryutilphoto(String sql, Object... args){
        ...
        try {
            ...
            if(resultSet.next()){
                ...
                for(int i=0;i<columnCount;i++){
                    ...
                    Field field = Userphoto.class.getDeclaredField(columnName);
                    field.setAccessible(true);
                    field.set(userphoto,columnvalue);
